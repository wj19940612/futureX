...
public class MultipartRequest<T> extends Request<T> {
	 ...
	 * @param params
	 */
	public MultipartRequest(int method, String url, ReqHeaders headers, String filePartName, File file, ReqParams params,
	 ...
	 * @param params
	 */
	public MultipartRequest(int method, String url, ReqHeaders headers, String filePartName, List<File> files, ReqParams params, Type type, ReqCallback<T> callback) {
		super(Method.POST, url, callback);
		this.headers = headers != null ? headers.get() : null;
		this.params = params != null ? params.get() : null;
		mFilePartName = filePartName;
