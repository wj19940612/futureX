package com.songbai.futurex.view.autofit;
...
import com.songbai.futurex.view.autofit.AutofitHelper;

public class AutoAdjustSizeEditText extends AppCompatEditText implements AutofitHelper.OnTextSizeChangeListener {
    ...
    public AutoAdjustSizeEditText(Context context, AttributeSet attrs, int defStyle) {
