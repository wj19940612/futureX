...
public class TitleBar extends RelativeLayout {
    ...
    private void processAttrs(AttributeSet attrs) {
        ...
        if (mSplitLineColor == null) {
            mSplitLineColor = ColorStateList.valueOf(Color.parseColor("#ddd"));
        }
    ...
    private void init() {
        ...
        int paddingHorizontal = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 14,
                getResources().getDisplayMetrics());
        int imageSide = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20,
                getResources().getDisplayMetrics());
        ...
        params = new LayoutParams(imageSide, imageSide);
        mRightImage.setVisibility(GONE);
        mRightViewParent.addView(mRightImage, params);
    ...
    public void setRightImageViewVisible(boolean visible) {
        mRightImage.setVisibility(visible ? VISIBLE : INVISIBLE);
    }
